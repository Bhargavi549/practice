...
// dependencies: It contains the packages which we used in projcet(dev and prod),
...
// devDependencies --> Need for local development and testing.
// devDependencies --> npm i package_name --save-dev

// 2. envirnoment and evnirnoment variables
// envirnoment -> local, dev, prod
// envirnoment variables -> which we can define in .env file, and we can use in the project, its nothing but global variables,
